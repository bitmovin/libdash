...
#ifndef SAMPLEPLAYER_MPD_ABSTRACTREPRESENTATIONSTREAM_H_
#define SAMPLEPLAYER_MPD_ABSTRACTREPRESENTATIONSTREAM_H_
...
#endif /* SAMPLEPLAYER_ADAPTATION_ABSTRACTADAPTATIONLOGIC_H_ */
