...
#ifndef SAMPLEPLAYER_MPD_SINGLEMEDIASEGMENTSTREAM_H_
#define SAMPLEPLAYER_MPD_SINGLEMEDIASEGMENTSTREAM_H_
...
#endif /* SAMPLEPLAYER_MPD_SINGLEMEDIASEGMENTSTREAM_H_ */
