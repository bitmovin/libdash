...
#ifndef SAMPLEPLAYER_ADAPTATION_MANUALADAPTATION_H_
#define SAMPLEPLAYER_ADAPTATION_MANUALADAPTATION_H_
    ...
    namespace adaptation
    {
        class ManualAdaptation : public AbstractAdaptationLogic
        {
            public:
                ...
                virtual input::MediaObject*         GetInitSegment      ();
            ...
            private:
                ...
                dash::mpd::IAdaptationSet                   *adaptationSet;
                dash::mpd::IRepresentation                  *representation;
                sampleplayer::mpd::AdaptationSetStream      *adaptationSetStream;
                sampleplayer::mpd::IRepresentationStream    *representationStream;
...
#endif /* SAMPLEPLAYER_ADAPTATION_MANUALADAPTATION_H_ */